...
class Assets
{
    ...
    public function frontend_script()
    {
        ...
        $script_asset_path = PluginInfo::getPluginDir() . "/build/frontend.asset.php";
        $booking_asset_path = PluginInfo::getPluginDir() . "/build/booking.asset.php";
    ...
    public function booking_script()
    {
        ...
        $script_asset_path = PluginInfo::getPluginDir() . "/build/booking.asset.php";
        ...
        wp_set_script_translations('booking-view', 'events', PluginInfo::getPluginDir()  . '/languages');
    ...
    public function editor_script()
    {
        ...
        $script_asset_path = PluginInfo::getPluginDir() . "/build/index.asset.php";
        if (! file_exists($script_asset_path)) {
            return;
        }
