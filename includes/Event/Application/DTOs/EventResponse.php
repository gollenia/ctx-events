...
class EventResponse implements DTO
{
    public function __construct(
		...
		public readonly ?TicketResponseCollection $ticketDtos = null
    ) {
    }
    ...
    public static function fromDomainModel(
		...
		?TicketResponseCollection $ticketDtos = null,
		?EventBookingSummary $bookingSummary = null
