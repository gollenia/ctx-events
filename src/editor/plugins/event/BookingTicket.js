				...
				<tr>
					<td>
						<input
							...
							onChange={(event) =>
								setData({ ...data, ticket_name: event.target.value })
							}
						/>
					</td>
					<td>
						<input
							...
							onChange={(event) =>
								setData({ ...data, ticket_description: event.target.value })
							}
						/>
					</td>
					<td>
						<input
							...
							onChange={(event) =>
								setData({ ...data, ticket_price: event.target.value })
							}
						/>
					</td>
					<td>
						<input
							...
							onChange={(event) =>
								setData({ ...data, ticket_spaces: event.target.value })
							}
						/>
					</td>
					<td>
						<input
							...
							onChange={(event) =>
								setData({ ...data, ticket_min: event.target.value })
							}
						/>
					</td>
					<td>
						<input
							...
							onChange={(event) =>
								setData({ ...data, ticket_max: event.target.value })
							}
						/>
					</td>
					<td>
						<input
							...
							onChange={(event) =>
								setData({ ...data, ticket_start: event.target.value })
							}
						/>
					</td>
