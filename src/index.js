...
domReady( function () {
	if ( window.typenow !== 'ctx-event' ) unregisterBlockType( 'events-manager/details' );
	if ( window.typenow !== 'ctx-event' ) unregisterBlockType( 'events-manager/booking' );
	if ( window.typenow !== 'ctx-location' ) unregisterBlockType( 'events-manager/locationeditor' );
	if ( window.typenow !== 'ctx-bookingform' && window.typenow !== 'ctx-attendeeform' )
