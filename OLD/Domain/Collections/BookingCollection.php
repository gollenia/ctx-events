...
use Contexis\Events\Infrastructure\Persistence\BookingRepository as PersistenceBookingRepository;
...
class BookingCollection implements IteratorAggregate, Countable, \JsonSerializable {
	...
	public static function from_booking_ids(array $booking_ids) : BookingCollection {
		...
		foreach( $booking_ids as $booking_id ){
			$instance->items[] = BookingRepository::get_by_id(absint($booking_id));
		}
		return $instance;
	}
	...
	function ticket_exists($ticket_id) : bool {
